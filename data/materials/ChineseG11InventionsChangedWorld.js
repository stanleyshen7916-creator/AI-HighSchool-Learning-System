  ...
  AHS.MaterialRepository.register({
    ...
    questionBank: {
      singleChoice: [
        ...
        { id: ID + "-q3", origin: "textbook-verified", questionForm: "內容理解", text: "課本旁欄以「人類大歷史三部曲」為標題，列出賈德．戴蒙的代表著作。下列何者不屬於其中？",
        ...
        { id: ID + "-q6", origin: "textbook-verified", questionForm: "圖表資料理解／篇旨呼應", text: "課本旁欄「愛迪生與留聲機」提及愛迪生1877年發明的圓筒式錄音裝置。關於這項發明最初的用途，下列敘述何者正確？",
          options: [
            { key: "A", text: "最初並非以販售音樂為主要用途，是後來才漸漸被此用途取代" },
            { key: "B", text: "從發明之初就設計為播放音樂唱片之用" },
            { key: "C", text: "主要設計來取代電話作為長途通話工具" },
            { key: "D", text: "是愛迪生為了替留聲機專利訴訟而製造的展示品" }
          ],
          correctAnswer: "A", knowledgePoint: "旁欄資料理解、篇旨呼應", difficulty: "中等",
          explanation: "A：旁欄說明愛迪生最初發明的圓筒式留聲機並非設計來販售音樂唱片，呼應本文「發明未必因應原先設想的需求而普及」的核心論點，正確。B：與旁欄敘述相反，錯誤。C、D：課本旁欄並無此敘述，屬編造的干擾選項。" },
        { id: ID + "-q7", origin: "textbook-verified", questionForm: "發明家與領域對應", text: "課本頁32–33側欄之發明家索引列出摩斯（Samuel Morse）、惠斯登（Charles Wheatstone）等人，這組發明家的專業領域最集中於下列哪一項？",
        ...
        { id: ID + "-q8", origin: "textbook-verified", questionForm: "發明家與發明對應", text: "課本側欄之發明家索引將萊特兄弟（Wright brothers）列為哪一類發明的代表人物？",
        ...
        { id: ID + "-q11", origin: "ai-derived", questionForm: "正反例證分類（Level 2 補充）", text: "本文舉愛迪生留聲機、早期機動車等例子，說明多數發明其實是「先有發明、後有需求」，翻轉了「先有需求，才有發明」的通俗認知。依此論證脈絡，下列哪一項發明實例，最不符合本文「發明為需求之母」的舉例方向，反而最符合「先有需求、才有發明」的傳統認知？",
        ...
        { id: ID + "-q13", origin: "ai-derived", questionForm: "發明家系譜與課文脈絡對應（Level 2 補充）", text: "課本頁32–33側欄之發明家索引，列出摩斯電報、萊特兄弟飛機等多組發明的相關人物系譜。下列哪一組「先驅者→後繼發明家」的對應關係最為合理？",
