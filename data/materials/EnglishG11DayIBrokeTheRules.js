  ...
  AHS.MaterialRepository.register({
    ...
    questionBank: {
      singleChoice: [
        ...
        { id: ID + "-rc2", origin: "ai-derived", questionForm: "內容理解（General Understanding，課本 Comprehension Practice 原題）", text: "敘事者在文末寫道：「Some things in life, after all, were more important.」（有些事情，終究比規則更重要。）綜合這句話與全文情節發展，下列何者最適合描述這篇文章？",
          options: [
        ...
        { id: ID + "-rc4", origin: "ai-derived", questionForm: "內容理解細節（Note the Details）", text: "課文寫道：「One of the rules of my job was never to visit the children alone when I was dressed as Ronald, for I might frighten them with my painted face and red wig. I wasn't permitted to have any physical contact with the children either, since doing so might pass on germs to them.」根據這段課文，敘事者扮演 Ronald 時必須遵守哪兩項規定？為什麼？下列配對何者正確？",
          options: [
        ...
        { id: ID + "-rc5", origin: "ai-derived", questionForm: "內容理解（推論因果，課本 Reading Comprehension 原題）", text: "Billy 過世前曾對母親說：「Mommy, I don't mind if I can't see Santa this year because I've hugged Ronald.」根據課文內容，下列何者最適合說明 Billy 的媽媽想感謝敘事者的原因，以及 Billy 這句話的意涵？",
          options: [
        ...
        { id: ID + "-voc1", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "With his restaurant business growing fast, Mr. Finch decided to ______ more people to serve the customers.",
          options: [{ key: "A", text: "employ" }, { key: "B", text: "refuse" }, { key: "C", text: "confine" }, { key: "D", text: "suffer" }],
          correctAnswer: "A", knowledgePoint: "Words for Production - employ", difficulty: "易",
          explanation: "employ (vt.) 意為「僱用」，句意是 Finch 先生因生意成長而決定「僱用」更多人手服務顧客，符合語境；refuse（拒絕）、confine（侷限）、suffer（受苦）皆為本課其他詞彙，代入句中語意皆不通順。" },
        ...
        { id: ID + "-voc3", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "Uncle Harry ______ from a heart condition, so the doctors told him to cut down on fatty foods.",
          options: [{ key: "A", text: "hesitates" }, { key: "B", text: "confines" }, { key: "C", text: "prompts" }, { key: "D", text: "suffers" }],
          correctAnswer: "D", knowledgePoint: "Words for Production - suffer", difficulty: "易",
          explanation: "suffer (vi.) 意為「受苦；(from) 罹患，受……之苦」，suffer from a heart condition 即「罹患心臟疾病」，故醫生建議他少吃高脂食物，符合語境；hesitate（猶豫）、confine（侷限）、prompt（促使）皆為本課其他詞彙，代入句中語意皆不通順。" },
        ...
        { id: ID + "-voc6", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "Aunt Mimi was ______ thankful when the firefighters rescued her cat from the tree.",
          options: [{ key: "A", text: "frail" }, { key: "B", text: "tremendously" }, { key: "C", text: "drowsy" }, { key: "D", text: "terminal" }],
          correctAnswer: "B", knowledgePoint: "Words for Production - tremendously/tremendous", difficulty: "易",
          explanation: "空格須為副詞，修飾後方形容詞 thankful，意為「非常感激」；tremendously (adv.) 意為「極度地，非常地」，符合詞性與語意。frail、drowsy、terminal 皆為形容詞，不能直接修飾另一個形容詞 thankful，詞性與語意皆不符。" },
        ...
        { id: ID + "-voc8", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "When the kids came around the corner dressed in zombie costumes for Halloween, they ______ the old lady almost to death.",
          options: [{ key: "A", text: "frightened" }, { key: "B", text: "employed" }, { key: "C", text: "suffered" }, { key: "D", text: "confined" }],
          correctAnswer: "A", knowledgePoint: "Words for Production - frighten/fright", difficulty: "易",
          explanation: "frighten (vt.) 意為「使（某人）驚嚇」，主詞是穿殭屍服裝出現的小孩，受詞是被嚇到的老太太，符合「使驚嚇」的語境；employ（僱用）、suffer（受苦）、confine（侷限）皆為本課其他詞彙，代入句中語意皆不通順。" },
        ...
        { id: ID + "-vocr2", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "Proper cleaning of your contact lenses will kill the ______ which may cause a serious eye infection.",
          options: [{ key: "A", text: "sparkles" }, { key: "B", text: "wigs" }, { key: "C", text: "laughter" }, { key: "D", text: "germs" }],
          correctAnswer: "D", knowledgePoint: "Words for Recognition - germ", difficulty: "易",
          explanation: "germ (n.) 意為「細菌」，指會導致生病或疾病的極微小物質，符合「清潔隱形眼鏡可殺死可能導致眼睛嚴重感染的東西」的語境；sparkle（閃耀）、wig（假髮）、laughter（笑聲）皆為本課其他詞彙，代入句中語意皆不通順。" },
        ...
        { id: ID + "-vocr4", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "After falling ill and spending a month in the hospital, the old man was very ______ and could hardly stand up.",
          options: [{ key: "A", text: "frail" }, { key: "B", text: "drowsy" }, { key: "C", text: "tremendous" }, { key: "D", text: "terminal" }],
          correctAnswer: "A", knowledgePoint: "Words for Recognition - frail", difficulty: "易",
          explanation: "frail (adj.) 意為「非常虛弱或病重的」，符合「老人生病住院一個月後身體虛弱到幾乎站不起來」的語境；drowsy（昏昏欲睡的）、tremendous（極大的）、terminal（末期的）皆為本課其他詞彙，代入句中語意皆不符（drowsy 指想睡而非虛弱無力）。" },
        ...
        { id: ID + "-vocr6", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "Despite being ______ to a wheelchair after the terrible accident, Lara remained as outgoing as ever.",
          options: [{ key: "A", text: "confined" }, { key: "B", text: "frightened" }, { key: "C", text: "prompted" }, { key: "D", text: "employed" }],
          correctAnswer: "A", knowledgePoint: "Words for Recognition - confine", difficulty: "中等",
          explanation: "confine (vt.) 被動語態 be confined to... 意為「受限於……」，符合「Lara 因意外而被迫使用輪椅，但仍一如既往地外向開朗」的語境；frighten（驚嚇）、prompt（促使）、employ（僱用）皆為本課其他詞彙，代入句中語意皆不通順。" },
        ...
        { id: ID + "-vocr9", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "Nicole didn't sleep well last night. No wonder she feels so ______ today.",
          options: [{ key: "A", text: "frail" }, { key: "B", text: "tremendous" }, { key: "C", text: "terminal" }, { key: "D", text: "drowsy" }],
          correctAnswer: "D", knowledgePoint: "Words for Recognition - drowsy", difficulty: "易",
          explanation: "drowsy (adj.) 意為「昏昏欲睡的」，句意是 Nicole 昨晚沒睡好，難怪今天感覺昏昏欲睡，語意連貫；frail（虛弱的）、tremendous（極大的）、terminal（末期的）皆為本課其他詞彙，代入句中語意皆不符。" },
        ...
        { id: ID + "-vocr12", origin: "textbook-verified", questionForm: "詞彙克漏字（本課單字為選項）", text: "When her boyfriend proposed, Kim didn't ______ about the decision at all. She answered \"Yes\" right away.",
          options: [{ key: "A", text: "hesitate" }, { key: "B", text: "refuse" }, { key: "C", text: "confine" }, { key: "D", text: "suffer" }],
          correctAnswer: "A", knowledgePoint: "Words for Recognition - hesitate/hesitation", difficulty: "易",
          explanation: "hesitate (vi.) 意為「猶豫」，因害怕或不確定而暫停；Kim 毫不猶豫地立刻答應求婚，符合語境；refuse（拒絕）、confine（侷限）、suffer（受苦）皆為本課其他詞彙，代入句中語意皆不通順（若填 refuse 則與後句「立刻答應」矛盾）。" },
        ...
        { id: ID + "-prn2", origin: "textbook-verified", questionForm: "詞彙字義", text: "課文中敘事者提及自己「painted face and red wig」的裝扮，wig 一詞最適合的中文意思為下列何者？",
        ...
        { id: ID + "-prn3", origin: "textbook-verified", questionForm: "詞彙字義", text: "課文提及敘事者「Though I understood the reasoning behind these rules...」句中，reasoning 一詞最適合的中文意思為下列何者？",
        ...
        { id: ID + "-gp3", origin: "textbook-verified", questionForm: "文法句型辨析", text: "課本 Sentence Pattern 印有此句型：「S + find/consider/feel/think... + it + adj./N + to VR」。下列哪一個句子的文法結構正確地運用了此句型？",
          options: [
        ...
        { id: ID + "-gp4", origin: "textbook-verified", questionForm: "文法句型應用（句子合併）", text: "課本 Sentence Pattern 練習「將兩句合併為一句」原句為：「It is a great achievement to win three championships. Many fans think so.」依句型公式合併後最恰當的句子為下列何者？",
          options: [
        ...
        { id: ID + "-lis3", origin: "textbook-verified", questionForm: "聽力策略理解", text: "課本 Listening Strategy 寫道：'By understanding some keywords or clues that signal agreement or disagreement, the conversation can be comprehended more easily.' 依此說明，理解對話中「同意／不同意」的訊號詞與關鍵字，對聽力理解最主要的幫助為下列何者？",
          options: [
