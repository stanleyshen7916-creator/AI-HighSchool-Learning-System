...
console.log("\n[1] 平時練習列表 — 真實顯示「選擇多課合併複習」按鈕，點擊後開啟真實課別複選畫面");
{
  ...
  check("Picker 真實顯示 5 個科目（生物＋國文＋英文＋歷史＋數學，本次 Workspace 範圍內的真實科目數，含 tm_5、tm_6、tm_7）",
    subjectChips.length === 5 && ["生物", "國文", "英文", "歷史", "數學"].every((s) => subjectChipNames.indexOf(s) !== -1));
