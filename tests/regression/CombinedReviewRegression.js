...
console.log("\n[1] 平時練習列表 — 真實顯示「選擇多課合併複習」按鈕，點擊後開啟真實課別複選畫面");
{
  ...
  check("Picker 真實顯示 6 個科目（生物＋國文＋英文＋歷史＋數學＋公民，本次 Workspace 範圍內的真實科目數，含 tm_5、tm_6、tm_7、tm_8、tm_9）",
    subjectChips.length === 6 && ["生物", "國文", "英文", "歷史", "數學", "公民"].every((s) => subjectChipNames.indexOf(s) !== -1));
